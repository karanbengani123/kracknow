...
function Quizview() {
    ...
    const ScheduleExam = async () => {
        ...
        let result = await fetch(`${Environment.server_url}/exams/schedule/${params.uuid}`,
            {
                method: "POST",
                body: JSON.stringify({ startTime, endTime, examTime, timeZone, type: "QUIZ" }),
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${JSON.parse(localStorage.getItem('token'))}`
                }
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0">Quiz View</h4>
                                        {/* <ToastContainer /> */}
                                        <div className="page-title-right">
                                            <ol className="breadcrumb m-0">
                                                <Link to="/Quiz" className="breadcrumb-item">Quiz</Link>
                                                <li className="breadcrumb-item active">Quiz View</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="row mb-3">
                                                                <div className="col-sm-6">
                                                                    <p className='mb-0'><b>Quiz Time</b><span className="required text-danger">*</span></p>
