...
const ExamNew = () => {
    ...
    const getQuestionlist = async (page) => {
        ...
        const list = result.payload.list.map((obj) => {
            // console.warn(questionListitem.findIndex((item) => item.uuid === obj.uuid)> -1)
            return {
                ...obj,
    ...
    const Addexam = async () => {
        ...
        rankList.map((val, index) => {
            ...
            // console.warn(parsedValue, "winning price")
        })
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0">New Exam</h4>
                                        <div className="page-title-right">
                                            <ol className="breadcrumb m-0">
                                                <Link to="/Exam" className="breadcrumb-item">Exam</Link>
                                                <li className="breadcrumb-item active">New Exam</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <form>
                                                    ...
                                                    <div className="form-row mb-4">
                                                        ...
                                                        <div className="col-sm-4">
                                                            ...
                                                            <input type="name" className="form-control" id="exampleFormControlInput1" placeholder="Exam title" onChange={(e) => { setTitle(e.target.value); titleSelected() }}></input>
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        onChange={(e) => {
                                                                                                            ...
                                                                                                            if (e.target.checked) {
                                                                                                                ...
                                                                                                                const idx = questionListitem.indexOf((obj) => obj.questionUUID === item.uuid) > -1;
                                                                                                                questionListitem.splice(idx, 1);
                                                                                                            }
                                                                                                            // setQuestionList(questionList);
                                                                                                            // console.warn(questionListitem,"*************after the checked part*********")
                                                                                                            // ExamQuestion.push({ questionUUID: item.uuid })
                                                                                                            // setExamQuestion(ExamQuestion)
                                                                                                        }}
