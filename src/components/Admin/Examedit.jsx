...
const Examedit = () => {
    ...
    const getSubcategory = async (id) => {
        // console.warn(id.length,"id inside the getsubcategory")
    ...
    // console.warn(categoryUUID, "above the set category");
    const updateSubcategoryHandler = (id) => {
        setcategoryUUID(id)
        // console.warn(categoryUUID, "inside sub-category hander")
        // setFilterCategory(id);
        console.warn(id.length,"id length",id,"Id");
        getSubcategory(id);
    };
    ...
    // console.warn(questions,"outsideside get call")
    ...
    useEffect(() => {
        if (rankingFactor.length) {
            ...
            Array.from(document.getElementsByClassName('examList')).map((currObj, index) => {
                // console.log("***",prizeAmount[index])
                // currObj.getElementsByTagName("input")[0].value = 786
                currObj.getElementsByTagName("select")[0].value = rankingFactor[index].type ? rankingFactor[index].type : ''
    ...
    const updateExam = async () => {
        ...
        console.warn(ExamQuestion, "inside the update exam")
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0">Edit Exam</h4>
                                                                                        ...
                                                                                        <div className="form-check form-switch">
                                                                                            <input className="form-check-input"
                                                                                                ...
                                                                                                onChange={(e) => {
                                                                                                    ...
                                                                                                    // console.warn(questions, "After Psuh")
