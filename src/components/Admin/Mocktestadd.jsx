...
const Mocktestadd = () => {
    ...
    const [type, setType] = useState("MOCK_TEST")
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0">New Mocktest</h4>
                                        <div className="page-title-right">
                                            <ol className="breadcrumb m-0">
                                                <Link to="/Exam" className="breadcrumb-item">Mocktest</Link>
                                                <li className="breadcrumb-item active">New Mocktest</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <form>
                                                    ...
                                                    <div className="form-row mb-4">
                                                        ...
                                                        <div className="col-sm-4">
                                                            ...
                                                            <input type="name" className="form-control" id="exampleFormControlInput1" placeholder="Mocktest title" onChange={(e) => { setTitle(e.target.value); titleSelected() }}></input>
