...
const Tournamentedit = () => {
    ...
    const getExamDetails = async () => {
        ...
        console.log(result.payload.response.videoAdUrl)
                                                            ...
                                                            <div className="container-exam">
                                                                ...
                                                                >
                                                                    {!imgPreviewId && (
                                                                        <>
                                                                            {/* <p>ID Proof</p> */}
                                                                            <label htmlFor="fileUpload1" className="customFileUpload"> Add banner </label>
                                                                            <input type="file"
                                                                                id="fileUpload1"
                                                                                onChange={(e) => {
