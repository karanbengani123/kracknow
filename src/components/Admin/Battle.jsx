...
function Battle() {
    ...
    const getExam = async (page) => {
        setLoading(true)
        let result = await fetch(`${Environment.server_url}/exams?type=BATTLE&limit=${itemsPerPage}&page=${page}&categories=${filter}&filter=${filters}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                // "type":"EXAM",
    ...
    const searchtable = async (key) => {
        ...
        setLoading(true)
        let result = await fetch(`${Environment.server_url}/exams?type=BATTLE&q=${key}`,
            {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0">Battle List</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div className="col-sm-2">
                                                    <select className="form-select form-select mb-2" aria-label="Default select example" onClick={getExam} onChange={(e) => { setFilters(e.target.value) }}>
                                                        <option value={""}>Filter Battle</option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="text-sm-end">
                                                        <div>
                                                            <Link to="/Battleadd" className="btn btn-success mb-2 addstudent"><i className="mdi mdi-plus me-1" />Add Battle</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td id="tooltip-container1" >
                                                                                <div className="iconss">
                                                                                    <Link to={"/Battleview/" + item.uuid} className="me-1 text-primary" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><i className="mdi mdi-eye font-size-18" /></Link>
                                                                                    <Link to={"/Battleedit/" + item.uuid} className="me-1 text-primary" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i className="mdi mdi-pencil font-size-18" /></Link>
