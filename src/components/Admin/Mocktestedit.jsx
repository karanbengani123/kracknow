                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0">Edit Mocktest</h4>
                                        <div className="page-title-right">
                                            <ol className="breadcrumb m-0">
                                                <Link to="/Mocktest" className="breadcrumb-item">Mocktest</Link>
                                                <li className="breadcrumb-item active">Edit Mocktest</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div className="form">
                                                <form>
                                                    ...
                                                    <div className="button mt-3">
                                                        ...
                                                        <Link to="/Mocktest"><button type="button" class="btn">Cancel</button></Link>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
