                            ...
                            <div className="row">
                                <div className="col-12 tabContent mb-3">
                                    <div className="col-sm-4 tabArea">
                                        <TabNavItem title="Exam" id="tab1" activeTab={activeTab} setActiveTab={setActiveTab}/>
                                    </div>
                                    <div className="col-sm-4 tabArea ml">
                                        <TabNavItem title="Scheduled Exam" id="tab2" activeTab={activeTab} setActiveTab={setActiveTab} />
                                    </div>
                                    <div className="col-sm-4 tabArea">
                                        <TabNavItem title="Completed Exam" id="tab3" activeTab={activeTab} setActiveTab={setActiveTab} />
                                    </div>
                                </div>
                            </div>
                            <div>
