...
const Item = ({ title, title1 }: any) => (
    <View style={styles.item}>
        <Image style={{ width: 280, height: 130, borderRadius: 20 }} source={require("../../../assets/images/quiz.jpg")}></Image>
...
export default class RecommendedQuiz extends React.PureComponent<Props, State> {
    ...
    renderItem = ({ item }: any) => (
        <TouchableOpacity onPress={() => this.props.navigation.navigate('QuizDetails')}>
