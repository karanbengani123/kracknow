...
import { GetCompletedExamListAPI, GetExamListAPI, GetScheduleListAPI } from '../../api-services/User.api';
...
export default class CompletedExamScreen extends React.Component<Props, State> {
        ...
        >
            <View style={styles.item}>
                <View style={{ borderWidth: 1, borderColor: '#EEEEEA', }}>
                    ...
                    </View><View style={{ backgroundColor: 'yellow', position: 'absolute', marginTop: 10, padding: 2, borderRadius: 5, marginLeft: 10 }}>
