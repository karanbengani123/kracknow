...
export default class ExamDoneResultScreen2 extends React.Component<Props, State> {
    ...
    renderItem2 = ({ item, index }: any) => (
        <View style={{}}>
            <Text style={{ marginBottom: 15, alignSelf: 'center', color: 'black' }}>Sub-category: {item.subCategoryName}</Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginBottom: 40 }}>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={{ color: 'black' }}>Correct ({item.correctAnswer})</Text>
                </View>

                <View style={{ flexDirection: 'row' }}>
                    <View style={{ backgroundColor: '#F44336', height: 20, width: 50, marginRight: 5 }}>
                    </View>
                    <Text style={{ color: 'black' }}>In-correct ({item.incorrectAnswer})</Text>
                </View>
