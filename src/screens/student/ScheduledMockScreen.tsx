...
import { GetExamListAPI, GetScheduleListAPI, GetScheduleMockListAPI } from '../../api-services/User.api';
...
export default class ScheduledMockScreen extends React.Component<Props, State> {
