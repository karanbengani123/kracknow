...
import { GetExamListAPI, GetScheduleListAPI, GetScheduleTournamentListAPI } from '../../api-services/User.api';
...
export default class ScheduledTournamentScreen extends React.Component<Props, State> {
