...
export default class ExamQuestion extends React.Component<Props, State> {
  selected: any;
  style: any;
  options: any;
        ...
        .then(
          (res: {
            ...
            if (res.statusCode === 200) {
              ...
              console.log(this.state.answerGiven, "answer given previous")
              console.log(this.state.selectedOption, "selectedOption given previous")
        ...
        .then(
          (res: {
            ...
            if (res.statusCode === 200) {
              ...
              console.log(this.state.answerGiven, "answer given next")
              console.log(this.state.selectedOption, "selectedOption given next")
        ...
        .then(
          (res: {
            ...
            if (res.statusCode === 200) {
              ...
              this.props.navigation.navigate("ExamResultTimeout", {
                participantUuid: this.props.route.params?.participantUuid,
              });
            }
