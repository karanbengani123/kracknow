...
import { GetRecommendedExamListAPI, GetUpcomingExamListAPI } from '../../api-services/User.api';
...
export default class RecommendedExams extends React.Component<Props, State> {
    ...
    componentDidMount(): void {
        this._getRecommendedExamListHandler();
    ...
    _getRecommendedExamListHandler(): void {
        // <ActivityIndicator size="small" color="#0000ff" />
      
      
        GetRecommendedExamListAPI()
            .then(response => {
