...
export default class WithdrawPendingScreen extends React.Component<Props, State> {
    ...
    _getWithdrawListHandler(): void {
        ...
        //         // debugger;
        //         this.setState({
        //             withdrawList: res.data.payload
        //         });

        //     });
        GetWithdrawListAPI()
            .then(response => {
                const successRecords = response.payload.Wallettransactionslist.rows.filter(record => record.status === "PENDING");
