...
import { GetExamDetailsAPI, GetStartExamonTimeAPI, GetSubcategoryAPI, PayPaymentApi, registerAPI, unregisterAPI } from '../../api-services/User.api';
...
export default class ExamDetailsScreen extends React.Component<Props, State> {
    ...
    startExamonTime(): void {
        ...
        GetStartExamonTimeAPI(this.state.examDetails.schedule[0].studentExam.uuid, payload)
            ...
            .then((res: {
                ...
                if (res.statusCode === 200) {
                    this.props.navigation.navigate('ExamStart', {
                        examUuid: this.state.examDetails.uuid,
...

                        {
                            ...
                            <View style={{ padding: 20 }}>
                                ...
                                <View style={{ paddingTop: 10 }}>
                                    {/* <Text>{this.state.examRankingFactor.length}hh</Text> */}
