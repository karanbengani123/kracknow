...
import { GetUpcomingExamListAPI, GetUpcomingQuizListAPI } from '../../api-services/User.api';
...
export default class UpcomingQuizzes extends React.Component<Props, State> {
