...
import { GetMockListAPI } from '../../api-services/User.api';
...
export default class AllMockScreen extends React.Component<Props, State> {
    ...
    renderItem1 = ({ item }: any) => (
        <TouchableOpacity onPress={() => this.props.navigation.navigate('MockDetails', { uuid: item.schedule[0].uuid })}>
        ...
        GetMockListAPI()
            ...
            .then((res: {
                ...
                if (res.statusCode === 200) {
                    this.setState({
                        mockList: res.data.payload.response
                    });
                }
