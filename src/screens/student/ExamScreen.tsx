...
export default class ExamScreen extends React.Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            ...
            examList: [],
            isLoading: true,
            selectedTab2: this.props.route.params?.tab || 'All Exams',
            tabList: [
                'All Exams',
                'Scheduled Exams',
                'Completed Exams'
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <ScrollView style={{ paddingRight: 10 }}>
                            {this.state.selectedTab2 === 'All Exams' &&
                                <AllExamScreen


                                    navigation={this.props.navigation} />}
                            {this.state.selectedTab2 === 'Scheduled Exams' &&
                                <ScheduledExamScreen


                                    navigation={this.props.navigation} />}
                            {this.state.selectedTab2 === 'Completed Exams' &&
                                <CompletedExamScreen
