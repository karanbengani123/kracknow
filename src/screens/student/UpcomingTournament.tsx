...
import { GetUpcomingExamListAPI, GetUpcomingQuizListAPI, GetUpcomingTournamentListAPI } from '../../api-services/User.api';
...
export default class UpcomingTournament extends React.Component<Props, State> {
            ...
            <View style={styles.item}>
                <View style={{borderWidth:1, borderColor:'#EEEEEA', borderRadius:10}}>
                    ...
                    <View style={{ padding: 10, }}>
                        ...
                        <Text style={{ fontSize: 10, fontWeight: '400', color: '#00000', opacity: 0.6, marginTop: 10 }}>Total seat: {item.tournament.studentLimit}</Text>
