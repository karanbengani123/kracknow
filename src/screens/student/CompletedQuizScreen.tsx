...
import { GetCompletedExamListAPI, GetCompletedQuizListAPI, GetExamListAPI, GetScheduleListAPI } from '../../api-services/User.api';
...
export default class CompletedQuizScreen extends React.Component<Props, State> {
