...
import { GetQuizListAPI } from '../../api-services/User.api';
...
export default class AllQuizScreen extends React.Component<Props, State> {
    ...
    renderItem1 = ({ item }: any) => (
        <TouchableOpacity onPress={() => this.props.navigation.navigate('QuizDetails', { uuid: item.schedule[0].uuid })}>
        ...
        GetQuizListAPI()
            ...
            .then((res: {
                ...
                if (res.statusCode === 200) {
                    this.setState({
                        quizList: res.data.payload.response
                    });
                }
