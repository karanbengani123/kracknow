...
export default class MockQuestion extends React.Component<Props, State> {
  selected: any;
  style: any;
  options: any;
  ...
  _getPrevNextExamQuestionHandler(): void {
    ...
    // console.log("store data", this.state.prevQuestionData, )
        ...
        .then(
          (res: {
            ...
            if (res.statusCode === 200) {
              ...
              this.props.navigation.navigate("MockResultTimeout", {
                participantUuid: this.props.route.params?.participantUuid,
              });
            }
