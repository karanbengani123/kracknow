...
import ScheduledQuizScreen from './ScheduledQuizScreen';
import CompletedQuizScreen from './CompletedQuizScreen';
...
export default class QuizScreen extends React.Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            ...
            examList: [],
            isLoading: true,
            selectedTab2: this.props.route.params?.tab || 'All Quizzes',
            tabList: [
                'All Quizzes',
                'Scheduled Quizzes',
                'Completed Quizzes'
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <ScrollView style={{ paddingRight: 10 }}>
                            {this.state.selectedTab2 === 'All Quizzes' &&
                                <AllQuizScreen


                                    navigation={this.props.navigation} />}
                            {this.state.selectedTab2 === 'Scheduled Quizzes' &&
                                <ScheduledQuizScreen


                                    navigation={this.props.navigation} />}
                            {this.state.selectedTab2 === 'Completed Quizzes' &&
                                <CompletedQuizScreen
