...
import { GetCompletedExamListAPI, GetCompletedQuizListAPI, GetScheduleListAPI } from '../../api-services/User.api';
...
export default class QuizLeaderboard extends React.Component<Props, State> {
