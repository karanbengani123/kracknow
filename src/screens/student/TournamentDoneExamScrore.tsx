...
export default class TournamentDoneExamScore extends React.Component<
    Props,
    State
> {
        ...
        GetTournamentMarksAPI(this.props.route.params?.examUUID, this.props.route.params?.participationUUID)
            ...
            .then(
                (res: {
                    ...
                    console.log(this.state.result, "resuuuuu")
                }
            );
    }
                            ...
                            >
                                ...
                                <View style={{ flexDirection: "row" }}>
                                    ...
                                    <Text
                                        style={{ fontWeight: "500", fontSize: 14, color: "#0A1042" }}
                                    >
                                        Wrong: {this.state.result.incorrect}
                                    </Text>
                                </View>
                            </View>
                            <View
          ...
          <Text style={{ color: 'red' }}>*Review will be published after completion of the exam</Text>
                        ...
                        <View style={{ alignItems: "center" }}>
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    this.props.navigation.navigate("TournamentReviewScreen", {
                    ...
                    <View style={{ alignItems: 'center', marginTop: 100 }}>
                        <Text style={{ color: 'red' }}>Exam not attended</Text>
                    </View>
