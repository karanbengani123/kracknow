...
import AllTournamentScreen from './AllTournamentScreen';
import ScheduledTournamentScreen from './ScheduledTournamentScreen';
import CompletedTournamentScreen from './CompletedTournamentScreen';
...
export default class TournamentScreen extends React.Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            ...
            examList: [],
            isLoading: true,
            selectedTab2: this.props.route.params?.tab || 'All Tournaments',
            tabList: [
                'All Tournaments',
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <ScrollView style={{ paddingRight: 10 }}>
                            {this.state.selectedTab2 === 'All Tournaments' &&
                                <AllTournamentScreen


                                    navigation={this.props.navigation} />}
                            {this.state.selectedTab2 === 'Scheduled Tournaments' &&
                                <ScheduledTournamentScreen


                                    navigation={this.props.navigation} />}
                            {this.state.selectedTab2 === 'Completed Tournaments' &&
    ...
    <Text style={{ fontWeight: '500', fontSize: 18, color: '#FFFFFF', paddingTop: 30 }}>Scheduled Exam</Text>
    ...
    <Text style={{ fontWeight: '500', fontSize: 18, color: '#0A1042', paddingTop: 30 }}>Exam done</Text>
