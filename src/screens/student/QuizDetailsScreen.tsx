...
import { GetQuizDetailsAPI, GetStartExamonTimeAPI, GetSubcategoryAPI, PayPaymentApi, registerAPI, unregisterAPI } from '../../api-services/User.api';
...
export default class QuizDetailsScreen extends React.Component<Props, State> {
    ...
    _getExamListHandler(): void {
        // debugger;
        GetQuizDetailsAPI(this.props.route.params?.uuid)
            .then(response => {
