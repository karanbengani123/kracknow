...
import ExamParticipationQuestion, {
  init as ExamParticipationQuestionInit,
} from "./ExamParticipationQuestion";
import ExamParticipationQuestionOption, {
  init as ExamParticipationQuestionOptionInit,
} from "./ExamParticipationQuestionOption";
import ExamPriceDistribution, {
  init as ExamPriceDistributionInit,
} from "./ExamPriceDistribution";
import ExamSchedule, { init as ExamScheduleInit } from "./ExamSchedule";
import ScheduleExamParticipation, {
  init as ScheduleExamParticipationInit,
} from "./ScheduleExamParticipation";
...
import StudentDeviceToken, {
  init as StudentDeviceTokenInit,
...
import TournamentBanner, {
  init as TournamentBannerInit,
} from "./TournamentBanner";
import TournamentCity, { init as TournamentCityInit } from "./TournamentCity";
import TournamentParticipation, {
  init as TournamentParticipationInit,
} from "./TournamentParticipation";
import TournamentExamSchedule, {
  init as TournamentExamScheduleInit,
} from "./TournamentExamSchedule";
import TournamentExamParticipationQuestion, {
  init as TournamentExamParticipationQuestionInit,
} from "./TournamentExamParticipationQuestion";
import TournamentExamParticipationQuestionOption, {
  init as TournamentExamParticipationQuestionOptionInit,
} from "./TournamentExamParticipationQuestionOption";
import TournamentKeyword, {
  init as TournamentKeywordInit,
} from "./TournamentKeyword";
import TournamentParticipationExam, {
  init as TournamentParticipationExamInit,
} from "./TournamentParticipationExam";
import Wallet, { init as WalletInit } from "./Wallet";
import WalletTransaction, {
  init as WalletTransactionInit,
} from "./WalletTransaction";
import WithdrawlRequest, {
  init as WithdrawlRequestInit,
} from "./WithdrawlRequest";
...
import ExamRankingFactor, {
  init as ExamRankingFactorInit,
} from "./ExamRankingFactor";
import TournamentPriceRatio, {
  init as TournamentPriceRatioInit,
} from "./TournamentPriceRatio";
import UserDeviceToken, {
  init as UserDeviceTokenInit,
...
import TournamentSchedule, {
  init as TournamentScheduleInit,
} from "./TournamentSchedule";
import TournamentRankingFactor, {
  init as TournamentRankingFactorInit,
} from "./TournamentRankingFactor";
import ScheduledRule, {
  init as ScheduledRuleInit,
} from "./ScheduledRule";
import PrizeAmountHistory, {
  init as PrizeAmountHistoryInit
} from "./PrizeAmountHistory";

import TournamentPriceDistribution, { init as TournamentPriceDistributionInit }
  from "./TournamentPriceDistribution";
